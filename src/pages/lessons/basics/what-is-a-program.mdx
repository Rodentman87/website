...
In the examples below, I'll use normal writing to make it clear what's going on, then over the course of these lessons, we'll gradually shift to actual JavaScript code. When the computer says something, it'll appear just below the code.
