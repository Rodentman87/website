...
With this we can run code for as many times as needed (even forever). Let's try putting this together with our variables to make the computer do something simple, in this case, multiplication.
